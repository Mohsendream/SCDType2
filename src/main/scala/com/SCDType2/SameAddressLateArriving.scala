...
object SameAddressLateArriving {
  ...
  def sameAddressLateArriving(joinedDataFarme: DataFrame, historyDataframe: DataFrame, spark: SparkSession): DataFrame = {
    val lateArrivingSameIdAddressDataframe = joinedDataFarme
